...
/* 
use this to laod the deck name and num of cards emaining as props

function Deck(props) {
    return (
      <li>
        <p className="deckName">{props.deckName}</p>
        <div className="cardsRemaining">{props.cardsRemaining}</div>
